    ...
    private fun uploadStory()
    {
        when{
            imageUri == null -> Toast.makeText(this,"Vui lòng chọn hình ảnh", Toast.LENGTH_LONG).show()
                ...
                progressDialog.setTitle("Thêm Tin")
                progressDialog.setMessage("Vui lòng đợi, chúng tôi đang thêm tin của bạn...")
                progressDialog.show()

                val fileRef = storageStoryPicRef!!.child(System.currentTimeMillis().toString() + "")
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if (task.isSuccessful)
                    {
                        ...
                        Toast.makeText(this,"Tin đã được tải lên thành công.", Toast.LENGTH_LONG).show()
