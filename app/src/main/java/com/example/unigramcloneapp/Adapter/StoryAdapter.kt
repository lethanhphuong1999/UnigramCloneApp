...
import com.example.unigramcloneapp.AddStoryActivity
...
import com.example.unigramcloneapp.StoryActivity
            ...
            override fun onDataChange(p0: DataSnapshot)
            {
                ...
                if (click)
                {
                    if (counter > 0)
                    {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "Xem Tin")
                        {
                ...
                else
                {
                    if (counter > 0)
                    {
                        textView.text = "Tin Của Tôi"
                        imageView.visibility = View.GONE
                    }
                    else
                    {
                        textView.text = "Thêm Tin"
