...
import com.example.unigramcloneapp.AccountSettingsActivity
import com.example.unigramcloneapp.Adapter.MyImagesAdapter
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        {
            view.edit_account_settings_btn.text = "Chỉnh Sửa Hồ Sơ"
        }
        ...
        view.edit_account_settings_btn.setOnClickListener {
            ...
            when
            {
                getButtonText == "Chỉnh Sửa Hồ Sơ" -> startActivity(Intent(context, AccountSettingsActivity::class.java))

                getButtonText == "Theo dõi" -> {
        ...
        if (followingRef != null)
        {
            followingRef.addValueEventListener(object : ValueEventListener
            {
                override fun onDataChange(p0: DataSnapshot)
                {
                    ...
                    {
                        view?.edit_account_settings_btn?.text = "Đang theo dõi"
                    }
                    else
                    {
                        view?.edit_account_settings_btn?.text = "Theo dõi"
                    }
                }
    ...
    private fun addNotification()
    {
        ...
        notiMap["text"] = "đã bắt đầu theo dõi bạn"
        notiMap["postid"] = ""
