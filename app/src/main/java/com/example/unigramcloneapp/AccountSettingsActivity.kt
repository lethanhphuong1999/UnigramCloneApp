...
class AccountSettingsActivity : AppCompatActivity()
{
    ...
    {
        when {
            TextUtils.isEmpty(full_name_profile_frag.text.toString()) -> Toast.makeText(this,"Vui lòng ghi rõ họ và tên.", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this,"Vui lòng ghi rõ tên người dùng.", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this,"Vui lòng ghi rõ thông tin của bạn.", Toast.LENGTH_LONG).show()
            else -> {
                ...
                Toast.makeText(this,"Thông tin tài khoản đã được cập nhật thành công.", Toast.LENGTH_LONG).show()
    ...
    private fun uploadImageAndUpdateInfo()
    {
        when
        {
            ...
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this,"Vui lòng ghi rõ thông tin của bạn.", Toast.LENGTH_LONG).show()
                ...
                progressDialog.setTitle("Cài đặt tài khoản")
                progressDialog.setMessage("Vui lòng đợi, chúng tôi đang cập nhật hồ sơ của bạn ...")
                progressDialog.show()
